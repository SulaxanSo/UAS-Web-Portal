...
<div id="background" class="container-fluid">
  <div class="row">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="orthomosaic">
              ...
              Orthophoto <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <p class="lead">UAV Orthophoto of the renatured segment of the river Aa near Münster, processed with WebODM. This orthophoto is provided by ESRI cloud as WMS layer.
</p>
  </div>
    </main>
  </div>
